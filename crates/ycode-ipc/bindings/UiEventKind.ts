...
export type UiEventKind = { "type": "SessionAppeared" } | { "type": "SessionTouched" } | { "type": "SessionRemoved" } | { "type": "ProjectAppeared" } | { "type": "ProjectRemoved" } | { "type": "TodosChanged" } | { "type": "PtyOutput", data: string, } | { "type": "PtyExit", code: number | null, } | { "type": "TitleChanged", title: string, } | { "type": "JsonlChanged", agent: string, jsonl_path: string, } | { "type": "AgentTurnComplete", 
/**
